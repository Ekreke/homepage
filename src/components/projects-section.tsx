...
import { ExternalLink, Github, ArrowUpRight } from 'lucide-react'; // Added ArrowUpRight
...
export function ProjectsSection({ language }: ProjectsSectionProps) {
  const content = {
      ...
      projects: [
        {
          ...
          image: "https://images.unsplash.com/photo-1658297063569-162817482fb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjB3ZWJzaXRlfGVufDF8fHx8MTc1NzEzMTc3M3ww&ixlib=rb-4.1.0&q=80&utm_source=figma&utm_medium=referral"
        },
        {
          ...
          image: "https://images.unsplash.com/photo-1597740985671-2a8a3b80502e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHAlMjBkZXNpZ258ZW58MXx8fHwxNzU3MDQ0Mjc1fDA&ixlib=rb-4.1.0&q=80&utm_source=figma&utm_medium=referral"
        },
        {
          ...
          image: "https://images.unsplash.com/photo-1554098415-788601c80aef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWIlMjBkYXNoYm9hcmR8ZW58MXx8fHwxNzU3MTY1NjkyfDA&ixlib=rb-4.1.0&q=80&utm_source=figma&utm_medium=referral"
        }
      ],
      viewAllProjects: "View All Projects" // Added
    },
    zh: {
      title: "精选项目",
      viewProject: "查看项目",
    ...
    de: {
      ...
      viewAllProjects: "Alle Projekte ansehen" // Added
    }
  };
  ...
  return (
    <section id="projects" className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12"> {/* Added mb-12 for spacing */}
